	...
	<aside class="left_bar" >
		...
		<section class="mainContent">
			<div class="dynamic_content">
				...
				<h1 id="title">Aggiorna quantità</h1>
				<div id="select_product">
					<form id="add_quant"  action="updateProduct" onsubmit="return check(this)" method="get">
						...
						<p id="quant"></p>
						<p><label>Inserisci nuova quantità quantità: </label><input type="number" name="newQuant" min="0" required="required" placeholder="Imposta quantità"></p>
						
						<div id="magazzino">
							<p><label>Inserisci il magazzino IT001:</label><input name="magazzino" id="magazzino" required="required" placeholder="IT001"></p>	
						</div>
