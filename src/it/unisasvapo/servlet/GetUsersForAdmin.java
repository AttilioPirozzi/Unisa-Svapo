...
@WebServlet("/getusersforadmin")
public class GetUsersForAdmin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		ArrayList<UserBean> getuserforadmin=information.GetUserForAdmin();
		request.setAttribute("users", getuserforadmin);
	}
