...
<%
	...
	String link_text=(String)request.getAttribute("link");
	...
	<aside class="left_bar" >
		...
		<section class="mainContent">
			<div class="dynamic_content">
				<h1 id="title">Aggiunta prodotto <%=state%></h1>
				<p><a href="pagecomposer?responsepage=addproduct"><%=link_text %></a></p>
				<%if(state.equals("riuscita")){ %>
					<h2>Fare click sul pulsante Scegli File per caricare un'immagine del prodotto</h2>
					<form method="post" action="fileupload" name="echo" enctype="multipart/form-data">
						<input type="hidden" value="<%=codP%>" name="prodName">
						<input type="file" name="image" size="50" required="required" accept="image/*">
						<p><input type="submit" value="Carica">
						<input type="reset"></p>
					</form>				
				<%} %>
			</div>
