...
<%
	...
	ArrayList<UserBean> userlist=(ArrayList<UserBean>)request.getAttribute("users");
%>
<%
			...
			<div class="dynamic_content">
				<%for (UserBean users:userlist) { %>
								...
								<table>
								 ...
								 <tbody>
									<tr>
									<td><%=users.getCodice()%></td>
									<td><%=users.getNome() %></td>
									<td><%=users.getCognome()%></td>
									<td><%=users.getCodFiscale()%></td>
									<td><%=users.getEmail()%></td>
									<td><%=users.getCitta()%></td>
									<td><%=users.getVia()%></td>
									<td><%=users.getnCivico()%></td>
									<td><%=users.getCap()%></td>
