	...
	<aside class="left_bar" >
		...
		<section class="mainContent">
			<div class="dynamic_content"> 
				<h1 id="title">Aggiornamento prodotto <%=state%></h1>
				<%if(state.equals("riuscita")){ %>
					<p><a href="pagecomposer?responsepage=login">Clicca qui per tornare al profilo</a></p>				
				<%} else{ %>
					<p><a href="pagecomposer?responsepage=updateproduct">Clicca qui per riprovare</a></p>
				<%} %>
			</div>
			</section>	
  </div>
